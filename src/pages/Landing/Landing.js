...
import bank1 from "../../assets/bank2.png";
        ...
        <>
          ...
          {data?.length > 0 ? (
            <>
              ...
              >
                <span onClick={() => selectPageHandler(page - 1)} className={page>1?"":classes["disable_button"]}>◀</span>
                ...
                <span onClick={() => selectPageHandler(page + 1)}
                      className={page<data.length/10?"":classes["disable_button"]}
                >▶</span>
              </div>
            </>
